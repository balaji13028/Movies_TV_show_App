...
class _CommonAppBarState extends State<CommonAppBar> {
  ...
  _onItemTapped(String page) async {
    Provider.of<HomeProvider>(context, listen: false).setCurrentPage(page);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Consumer<HomeProvider>(
                builder: (context, homeProvider, child) {
                  return MyText(
                    color: homeProvider.currentPage == bottomView1
                        ? primaryColor
                        : white,
                    multilanguage: false,
                    text: bottomView1,
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Consumer<HomeProvider>(
                builder: (context, homeProvider, child) {
                  return MyText(
                    color: homeProvider.currentPage == bottomView2
                        ? primaryColor
                        : white,
                    multilanguage: false,
                    text: bottomView2,
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Consumer<HomeProvider>(
                builder: (context, homeProvider, child) {
                  return MyText(
                    color: homeProvider.currentPage == bottomView3
                        ? primaryColor
                        : white,
                    multilanguage: false,
                    text: bottomView3,
          ...
          //               ? primaryColor
          //               : white,
          //           multilanguage: Constant.userID != null ? false : false,
          //           text: Constant.userID != null ? myProfile : "Settings",
          //           fontsizeNormal: 14,
          //           fontweight: FontWeight.w600,
          //           fontsizeWeb: 14,
          //           maxline: 1,
